...
export const MODEL_PRESETS: BackendModelPreset[] = [
  ...
  {
    model_id: "deepinfra-deepseek-v3-2-exp",
    name: "DeepSeek V3.2 Exp",
    description: "DeepSeek V3.2 Exp model, provided via DeepInfra.",
    max_context: 163_840,
    max_output: 163_840,
    input_token_price: 0.27 / 1_000_000.0,
    output_token_price: 0.4 / 1_000_000.0,
    maker: "deepseek",
    provider: "deepinfra",
    provider_model: "deepseek-ai/DeepSeek-V3.2-Exp",
    provider_endpoint: "https://api.deepinfra.com/v1/openai",
    max_image_attachments: 0,
    max_tools: 10,
    aa_score: [57],
  ...
  },
  {
    ...
    name: "GPT OSS 120B",
    description: "GPT OSS 120B model, provided via Groq.",
    max_context: 131_072,
    max_output: 65_536,
